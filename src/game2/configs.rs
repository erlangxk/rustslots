...
pub fn lines() -> Vec<Vec<C>> {
    vec![
        vec![C(0, 1), C(1, 1), C(2, 1), C(3, 1), C(4, 1)],
        vec![C(0, 0), C(1, 0), C(2, 0), C(3, 0), C(4, 0)],
        vec![C(0, 2), C(1, 2), C(2, 2), C(3, 2), C(4, 2)],
        vec![C(0, 0), C(1, 1), C(2, 2), C(3, 1), C(4, 0)],
        vec![C(0, 2), C(1, 1), C(2, 0), C(3, 1), C(4, 2)],
        vec![C(0, 0), C(1, 0), C(2, 1), C(3, 0), C(4, 0)],
        vec![C(0, 2), C(1, 2), C(2, 1), C(3, 2), C(4, 2)],
        vec![C(0, 1), C(1, 2), C(2, 2), C(3, 2), C(4, 1)],
        vec![C(0, 1), C(1, 0), C(2, 0), C(3, 0), C(4, 1)],
    ]
}
